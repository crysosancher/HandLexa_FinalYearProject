  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        <h1 style={{ color: 'MediumSeaGreen' }}>Problem Statement</h1>
        <h4>
      ...
      <div className="jumbotron">
        <h3 className="text-center" style={{ color: 'MediumSeaGreen' }} >1. Idea Solution</h3>
      ...
      <div className="jumbotron">
        <h3 className="text-center" style={{ color: 'MediumSeaGreen' }}>2. Dependencies / Limitations</h3>
        <div className="row justify-content-center">
          <img
      ...
      <div className="jumbotron">
        <h3 className="text-center" style={{ color: 'MediumSeaGreen' }}>3. What We Provide</h3>
        <div className="row justify-content-center">
          <img
      ...
      <div className="jumbotron">
        <h3 className="text-center" style={{ color: 'MediumSeaGreen' }}>4. Our Team</h3>
        <div className="row justify-content-center">
          <img
            src="tts.jpeg"
            alt="OpenCV Pipeline Demo"
